                                        ...
                                        const filler_strategy_fill_summary_t *summary)
{
    ...
    rec.measured_near_close_gain_g = summary->measured_near_close_gain_g;
    ...
    rec.rate_2sample_at_close_gps = summary->rate_2sample_at_close_gps;
    rec.rate_4sample_at_close_gps = summary->rate_4sample_at_close_gps;
    rec.rate_filtered_medium_at_close_gps = summary->filtered_rate_medium_at_close_gps;
    rec.rate_filtered_slow_at_close_gps = summary->filtered_rate_slow_at_close_gps;
    ...
    rec.used_slow_rate_gps = summary->used_slow_rate_gps;
    rec.used_near_close_bias_g = summary->used_near_close_bias_g;
    rec.used_near_close_g = summary->used_near_close_g;
    rec.used_close_early_g = summary->used_close_early_g;
    ...
    rec.learned_near_close_bias_g = summary->next_near_close_bias_g;
