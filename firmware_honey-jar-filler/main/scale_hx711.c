...
static bool scale_publish_telemetry_sample(int64_t ts_us, float weight_g)
{
    ...
    if (filler_get_strategy_sample_telemetry(&strategy_sample) && strategy_sample.valid) {
        ...
        rec.rate_2sample_gps = strategy_sample.rate_2sample_gps;
        rec.rate_4sample_gps = strategy_sample.rate_4sample_gps;
        rec.rate_filtered_gps = strategy_sample.filtered_rate_gps;
        rec.rate_filtered_medium_gps = strategy_sample.filtered_rate_medium_gps;
        rec.rate_filtered_slow_gps = strategy_sample.filtered_rate_slow_gps;
        ...
        rec.measured_near_close_gain_g = strategy_sample.measured_near_close_gain_g;
        ...
        rec.learned_near_close_bias_g = strategy_sample.learned_near_close_bias_g;
